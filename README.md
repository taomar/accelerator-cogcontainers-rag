...
- **Azure Document Intelligence Connected/Disconnected Container (you can use connected containers as well as disconnected following same, Disconnected containers needs prereservation) ** 
→ [Disconnected Containers]((https://learn.microsoft.com/en-us/azure/ai-services/document-intelligence/containers/disconnected?view=doc-intel-4.0.0#document-intelligence-container-models-and-configuration))
